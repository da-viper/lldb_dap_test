...
"""
    ...
    def _stop_at_breakpoint(self, session: DAPTestSession):
    ...
    def test_memory_refs_variables(self):
        ...
        top_frame = self._stop_at_breakpoint(session)
        locals = {l.name: l.variable for l in top_frame.locals.variables()}
