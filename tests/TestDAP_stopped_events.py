...
"""
    ...
    def build(self, filename=None):
        self.create_file(self.PSEUDO_BARRIER_H, "pseudo_barrier.h")
    ...
    def collect_two_stops(self, session: DAPTestSession, *, after):
        ...
        first = session.wait_for_event(StoppedEvent, after=after)
        second = session.wait_for_event(StoppedEvent, after=first)
