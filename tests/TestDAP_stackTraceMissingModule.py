...
from lldb_dap.dap_types import LaunchArgs, StoppedReason
...
"""
    ...
    def test_missingModule(self):
        ...
        expr_address = self.expect_is_not_none(
        ...
        frame_without_module = session.current_top_frame(stop_event.body.threadId).frame
        ...
        frame_source = self.expect_is_not_none(
