...
class TestDAP_exception_objc(testcase.DAPTestCaseBase):
    TEST_PROGRAM = r"""#import <Foundation/Foundation.h>
...
"""
    ...
    def build(self, filename=None):
        main_m = self.create_file(self.TEST_PROGRAM, "main.m")
        self.compile_program(
            filepath=main_m,
            extra_args=["-w", "-fobjc-exceptions", "-framework", "Foundation"],
        )
